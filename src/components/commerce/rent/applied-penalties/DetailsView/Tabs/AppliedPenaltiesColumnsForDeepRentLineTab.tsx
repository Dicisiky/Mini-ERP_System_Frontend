...
const AppliedPenaltiesColumnsForDeepRentLineTab = (
  rentId: string | undefined,
  rentLineId: string | undefined
): ColumnDef<FetchAppliedPenalty>[] => [
  {
    accessorKey: "id",
    header: ({ column }) => (
          ...
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="left">
              ...
              <DropdownMenuItem className="flex items-center gap-2">
                <PenIcon />
                <NavLink
                  to={`/rents/${rentId}/rent-lines/${rentLineId}/applied-penalties/update/${appliedPenalty.id}`}
                >
                  Edit
                </NavLink>
              </DropdownMenuItem>
...
export default AppliedPenaltiesColumnsForDeepRentLineTab;
