...
const AppliedPenaltiesColumnsForRentLineTab = (
          ...
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="left">
              ...
              <DropdownMenuItem className="flex items-center gap-2">
                <PenIcon />
                <NavLink
                  to={`/rent-lines/${rentLineId}/applied-penalties/update/${appliedPenalty.id}`}
                >
                  Edit
                </NavLink>
              </DropdownMenuItem>
...
export default AppliedPenaltiesColumnsForRentLineTab;
