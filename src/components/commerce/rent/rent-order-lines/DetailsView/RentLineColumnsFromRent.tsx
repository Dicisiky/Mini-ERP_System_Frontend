...
const RentLineColumnsFromRent = (
  rentId: string | undefined
): ColumnDef<FetchRentLineResponse>[] => [
  {
        ...
        <>
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="right">
              ...
              <DropdownMenuItem className="flex items-center gap-2">
                <EyeIcon />
                <NavLink
                  to={`/rents/${rentId}/rent-lines/view/${rentLine.rentLineId}`}
                >
                  Rent line details
                </NavLink>
              </DropdownMenuItem>
              ...
              >
                <PenIcon />
                <NavLink
                  to={`/rents/${rentId}/rent-lines/update/${rentLine.rentLineId}`}
                >
                  Edit
                </NavLink>
              </DropdownMenuItem>
          ...
          {isDeleteOpen && (
            <DeleteDialog
              ...
              removeQueryKey={["rent-order-lines", `${rentLine.rentLineId}`]}
              open={isDeleteOpen}
...
export default RentLineColumnsFromRent;
